function Board(el, scoreEl, rows = 4, cols = 4) {
    this.el = document.querySelector(el);
    this.spanScore = document.querySelector(scoreEl);
    this.rows = rows;
    this.cols = cols;
    this.score = 0;
...
const getRandomColors = function () {
    ...
    var oddColor = 'hsl(' + Math.round(360 * hue) + ',' + saturation + '%,' + (lightness + 15) + '%)';
